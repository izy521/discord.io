...
DCP.getReaction = function(input, callback) {
	input.limit = 100; // Default application value
	this._req('get', Endpoints.MESSAGE_REACTIONS(input.channelID, input.messageID, stringifyEmoji(input.reaction)) + "?limit=" + input.limit, function(err, res) {
