...
function APIRequest(method, url) {
	...
	if (isNode) {
		...
		if (type(data) === 'object' || type(data) === 'array' || method.toLowerCase() === 'get') req.setHeader("Content-Type", "application/json; charset=utf-8");
	...
	if (type(data) === 'object' || type(data) === 'array' || method.toLowerCase() === 'get') req.setRequestHeader("Content-Type", "application/json; charset=utf-8");
