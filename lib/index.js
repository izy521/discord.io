...
DCP.getReaction = function(input, callback) {
	...
	var client = this;
	resolveID(client, input.channelID, function(channelID) {
		this._req('get', Endpoints.MESSAGE_REACTIONS(channelID, input.messageID, stringifyEmoji(input.reaction)) + qstringify(qs), function(err, res) {
...
DCP.removeReaction = function(input, callback) {
	var client = this;
	resolveID(client, input.channelID, function(channelID) {
		this._req('delete', Endpoints.USER_REACTIONS(channelID, input.messageID, stringifyEmoji(input.reaction), input.userID), function(err, res) {
...
DCP.removeAllReactions = function(input, callback) {
	  var client = this;
	  resolveID(client, input.channelID, function(channelID) {
		this._req('delete', Endpoints.MESSAGE_REACTIONS(channelID, input.messageID), function(err, res) {
