(function discordio(Discord){
	...
	/**
	 * Edits (or creates) a permission override for a channel.
	 * @arg {Object} input
	 * @arg {Snowflake} channelID
	 * @arg {Snowflake} [userID]
	 * @arg {Snowflake} [roleID]
	 * @arg {Array} allow - An array of permissions to allow. Discord.Permissions.XXXXXX.
	 * @arg {Array} deny - An array of permissions to deny, same as above.
	...
	/**
	 * Retrieves all offline (and online, if using a user account) users, fires the `offlineUsers` event when done.
	 */
