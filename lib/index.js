(function(Discord){
	...
	var Endpoints = (function () {
		...
		return {
			...
			MESSAGE:  function(channelID, messageID) {
	...
	DCP.getMessage = function(input, callback) {
		this._req('get', Endpoints.MESSAGE(input.channelID, input.messageID), function(err, res) {
	...
	DCP.getMessages = function(input, callback) {
		...
		this._req('get', Endpoints.MESSAGE(input.channelID) + qstringify(qs), function(err, res) {
