...
DCP.editUserInfo = function(input, callback) {
	...
	for (var key in input) {
		if (plArr.indexOf(key) < 0) return handleErrCB(("'" + key + "' is not a valid key. Valid keys are: " + plArr.join(", ")), callback);
...
Discord.Types.Status = {
	Offline: 'offline',
	Online: 'online',
	Away: 'away',
	DND: 'dnd'
};
Discord.Types.Stream = {
	Twitch: 1
};
Discord.URL = {
