...
function handlevWSClose(voiceSession) {
	...
	if (audio._mixedDecoder && audio._mixedDecoder.destroy) audio._mixedDecoder.destroy();

	Object.keys(members).forEach(function(ID) {
		var member = members[ID];
		if (member.decoder && member.decoder.destroy) member.decoder.destroy();
	});
