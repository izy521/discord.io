...
DCP.ban = function(input, callback) {
	...
	this._req('put', Endpoints.BANS(input.serverID, input.userID) + "?reason=" + (input.reason ? input.reason : "" )+ (input.lastDays ? "&delete-message-days=" + input.lastDays : ""), function(err, res) {
